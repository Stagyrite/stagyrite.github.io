...
Standard programming languages doesn't have pipes. They'd need to evolve a syntax extension that is yet far too prototypical to me:\
&nbsp; 𝑥|y|𝑥|𝑦𝑦|𝑥|𝑦𝑦𝑦|𝑥|𝑦𝑦𝑦𝑦.\
Notwithstanding, I'm already pushed to call it a stream of _4 xs in 10 ys_. I'd call the visualization kit a stream-based graph generator, and [its interface](https://chat.openai.com/?model=gpt-4&q=Make%20an%20interface%20in%20Java%20with%20%27Graph.executeGrafana%28%29%27%2C%20%27Graph.onGrafanaUpdate%28%29%27%2C%20%27Graph.initializeGrafanaStream%28%29%27%2C%20and%20%27Graph.showGrafanaGraph%28%29%27. "ChatGPT") might have included methods:
1. 'Graph.execute()',
