...
Notwithstanding the above, five programming languages are worth knowing: Java, JavaScript, SQL, Python, and Perl. It's all a not-so-recent opinion, and therefore, replacements are allowed, for instance, Jython or Raku. C++ would be an interesting alternative, as it provides for handling concurrency differently from Java. I [speak Streem](https://stagyrite.github.io/screemer/ "screemer &#124; Stagyrite"), a stream-based prototype, but the opinion doesn’t fluctuate so extremely for it to matter.
